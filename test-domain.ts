...
import { Distance } from './src/domain/value-objects/distance.value-object';
import { Allergen } from './src/domain/value-objects/allergen.value-object';
import { Dish } from './src/domain/entities/restaurant/dish.entity';
import { Restaurant } from './src/domain/entities/restaurant/restaurant.entity';
import { Cart } from './src/domain/entities/order/cart.entity';
import { CartItem } from './src/domain/entities/order/cart-item.entity';
...
const price1Result = Price.create(15.99);
...
const price2Result = Price.create(5.50);
...
console.log('\n✅ Test 2: Coordinates and Distance');
const parisResult = Coordinates.create(48.8566, 2.3522);
const lyonResult = Coordinates.create(45.7640, 4.8357);
...
// Test 4: Allergen
console.log('\n✅ Test 4: Allergen');
const glutenResult = Allergen.create('GLUTEN');
const nutsResult = Allergen.create('NUTS');
...
console.log('\n✅ Test 5: Dish Entity with Stock Management');
const dishPriceResult = Price.create(12.99);
...
console.log('\n✅ Test 6: Restaurant Entity');
const emailResult = Email.create('contact@pizzeria.fr');
const phoneResult = Phone.create('+33123456789');
...
const cartItemPriceResult = Price.create(12.99);
...
const cartItem2PriceResult = Price.create(8.50);
...
console.log('\n✅ Test 9: Distance Calculation');
const restaurantCoords = Coordinates.create(48.8566, 2.3522);
const clientCoords = Coordinates.create(48.8606, 2.3376);
...
const distanceResult = Distance.create(deliveryDistance);
...
const pickupFeeResult = Price.create(2.50);
const pricePerKmResult = Price.create(1.50);
